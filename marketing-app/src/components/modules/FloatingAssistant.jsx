...
function greeting() {
  return {
    id: 1,
    role: 'assistant',
    text: "Hi! I'm your marketing assistant. I can look up campaigns, plans, tasks, costs, reports and more, or navigate to a page. You can also upload documents and ask me about them. How can I help?",
  };
}
            ...
            <div className="asst-brand">
              ...
              <div className="asst-brand-text">
                ...
                <div className="asst-brand-sub">
                  ...
                  {user ? (humanize ? 'Voice · Avatar mode' : 'Marketing Assistant') : 'Marketing Assistant'}
                </div>
              </div>
            </div>
...
function fallbackReply(text) {
  ...
  if (lower.includes('campaign'))
    return { text: "I'll take you to the Campaigns page.", action: 'campaigns' };
  if (lower.includes('plan') || lower.includes('calendar') || lower.includes('target'))
    return { text: "Opening the Marketing Plan section for you.", action: 'plans' };
  if (lower.includes('task'))
    return { text: "Taking you to the Marketing Tasks page.", action: 'tasks' };
  if (lower.includes('cost') || lower.includes('expense') || lower.includes('budget'))
    return { text: "Here's the Marketing Costs page for you.", action: 'costs' };
  if (lower.includes('proposal') || lower.includes('proforma') || lower.includes('tender'))
    return { text: "Opening the Proposals section for you.", action: 'proposals' };
  if (lower.includes('product') || lower.includes('service'))
    return { text: "Taking you to the Product & Service page.", action: 'products' };
  ...
  if (lower.includes('lead') || lower.includes('conversion') || lower.includes('kpi'))
    return { text: "Here's the Marketing Analysis section for you.", action: 'analysis' };
  if (lower.includes('help') || lower.includes('what can you do'))
    return {
      text: "I can help you navigate the dashboard quickly! Try asking me to:\n• Open campaigns\n• View the plan\n• Check tasks\n• See costs\n• Open reports\n• And more!",
    };
  return { text: "I can help you navigate the dashboard. Try asking about campaigns, plans, tasks, costs, or reports!" };
}