...
function greeting() {
  return {
    id: 1,
    role: 'assistant',
    text: "Hi! I'm your finance assistant. I can look up purchases, sales, inventory, payroll, reports and more, or navigate to a page. You can also upload documents and ask me about them. How can I help?",
  };
}
            ...
            <div className="asst-brand">
              ...
              <div className="asst-brand-text">
                ...
                <div className="asst-brand-sub">
                  ...
                  {user ? (humanize ? 'Voice · Avatar mode' : 'Finance Assistant') : 'Finance Assistant'}
                </div>
              </div>
            </div>
...
function fallbackReply(text) {
  ...
  if (lower.includes('purchase') || lower.includes('buy') || lower.includes('supplier'))
    return { text: "I'll take you to the Purchases page.", action: 'purchases' };
  if (lower.includes('sale') || lower.includes('sell') || lower.includes('invoice'))
    return { text: "Opening the Sales page for you.", action: 'sales' };
  if (lower.includes('inventory') || lower.includes('stock'))
    return { text: "Taking you to the Inventory page.", action: 'inventory' };
  if (lower.includes('account') || lower.includes('chart'))
    return { text: "Opening the Chart of Accounts for you.", action: 'accounts' };
  if (lower.includes('journal'))
    return { text: "Taking you to the General Journal.", action: 'journal' };
  if (lower.includes('payroll') || lower.includes('salary'))
    return { text: "Here's the Payroll page for you.", action: 'payroll' };
  ...
  return { text: "I can help you navigate the dashboard. Try asking about purchases, sales, inventory, payroll, or reports!" };
}